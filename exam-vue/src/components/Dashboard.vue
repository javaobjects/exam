  ...
  <div>
    ...
    <el-row>
      <el-col :span="15" :offset="5">
        <h3>系统描述:</h3>
        <p>在线考试系统是一个多角色在线考试系统，系统集成了用户管理、角色管理、题库管理、试题管理、考试管理、在线考试等功能，考试流程完善。实现一整套完整体系的在线考试系统，方便用
          户在此系统中进行练习并不断提升自己，在考试中不断进步。</p>
        <h3>主要功能</h3>
        <div style="margin-left: 2em">
          <h4>1.权限控制</h4>
          <p>本系统存在三个不同的角色，老师，管理员，学生三种用户，此系统是基于vue+springboot实现的前后端分离，用户权限校验通过JWT生成token令牌发放到用户，并根据令牌对用户的身份合法性进行校验。</p>

          <h4>2.在线考试</h4>
          <p>学生用户在注册登录之后，可以在本系统进行在线的考试，考试可由老师和管理员进行布置并设置考试权限（公开，密码），考试题型分为
          ...
          <h4>5.题库管理</h4>
          <p>超级管理员和老师可以对本在线考试系统已有的题库进行管理，实现对题库信息的CRUD操作</p>

          <h4>6.试题管理</h4>
          <p>老师和系统管理员用户有权限对本系统的所有试题进行操作，本系统试题支持复杂类型的题目，考试题目支持多插图，选项答案支持单插图功能。</p>

          <h4>7.考试管理</h4>
          <p>
            老师和系统管理员用户有权限对系统存在的考试进行操作，本系统考试支持公开考试和密码口令考试，并可以对考试进行禁用也可以在设置考试时间段，对于考试可以进行很便利的进行组卷，系统内置两种组卷模式，题库组卷和自由选题组卷。</p>
